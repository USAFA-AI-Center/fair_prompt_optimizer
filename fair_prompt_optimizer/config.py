...
try:
    ...
    def extract_prompts(*args, **kwargs):
        raise ImportError("fairlib not installed")

    def apply_prompts(*args, **kwargs):
        raise ImportError("fairlib not installed")
    ...
    def save_agent_config(*args, **kwargs):
        raise ImportError("fairlib not installed")

    def extract_multi_agent_config(*args, **kwargs):
        raise ImportError("fairlib not installed")

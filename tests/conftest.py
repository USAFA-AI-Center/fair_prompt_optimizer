...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "slow: marks tests as slow (require LLM)"
    )
    config.addinivalue_line(
        "markers", "requires_fairlib: marks tests that require fairlib"
    )
...
def sample_config_dict():
    ...
    return {
        ...
        "prompts": {
            ...
            "tool_instructions": [
                {"name": "calculator", "description": "Does math calculations"}
            ],
            "worker_instructions": [],

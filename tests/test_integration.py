...
try:
    from fairlib.utils.config_manager import extract_prompts, apply_prompts
...
class TestPromptBuilderIntegration:
    ...
    def test_extract_prompts(self):
        ...
        from fairlib.core.prompts import (
            PromptBuilder, RoleDefinition, ToolInstruction, 
    ...
    def test_round_trip(self):
        ...
        from fairlib.core.prompts import (
            PromptBuilder, RoleDefinition, Example
        )
        from fairlib.utils.config_manager import extract_prompts, apply_prompts
